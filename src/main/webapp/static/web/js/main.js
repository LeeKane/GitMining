d3.csv("/GitMining/static/web/data/languages.csv",function(d){
	...
	d3.csv("/GitMining/static/server/exports/"+last_quarter+".csv",function(q){
		...
		pc=new ParallelCoordinates(d3.values(events),{
			...
			help:{
				"name":"Programmin language of the Repositories.<br/>Ordered by activity rank.",
				"PushEventAll":"Total number of changes pushed to repositories with a defined language in the selected period of time.",
				"PushEventRepo":"Number of active repositories with a defined language in the selected period.<br/>A repository is considered active if at least one change has been pushed during the selected period of time.",
				"PushEvent":"Average number of changes pushed per repository in the selected period of time.",
				"year":"Year in which the programming language was released.",
				"ForkEvent":"Average number of forks per repository in the selected period of time.",
				"IssuesEvent":"Average number of opened issues per repository in the selected period of time.",
				"WatchEvent":"Average number of new watchers per repository in the selected period of time."
			},
			duration:1000,
			path:"/GitMining/static/server/exports/",
			extension:"csv"
		});
	});

	d3.csv("/GitMining/static/server/exports/active_quarters.csv?1234",function(d){
