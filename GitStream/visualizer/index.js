...
app.get('/ghpages-materialize.css', function(req, res) {
  res.sendFile(__dirname + '/ghpages-materialize.css');
});

app.get('/jquery.timeago.min.js', function(req, res) {
  res.sendFile(__dirname + '/jquery.timeago.min.js');
});

app.get('/prism.js', function(req, res) {
  res.sendFile(__dirname + '/prism.js');
});

app.get('/lunr.min.js', function(req, res) {
  res.sendFile(__dirname + '/lunr.min.js');
});

app.get('/materialize.js', function(req, res) {
  res.sendFile(__dirname + '/materialize.js');
});
...
app.get('/materialize.svg', function(req, res) {
  res.sendFile(__dirname + '/materialize.svg');
});
